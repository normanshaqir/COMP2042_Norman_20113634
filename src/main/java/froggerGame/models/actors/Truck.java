 ...
 * <h1>Truck</h1>
 * <p>
 * The {@code Truck} class invokes the superclass {@Code Obstacle} constructor.
...
public class Truck extends Obstacle {
	/**
	 * Invokes Obstacle's constructor while also setting the respawn and despawn positions.
	 * 
